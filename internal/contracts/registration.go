...
// Register is a paid mutator transaction binding the contract method 0xd8d64da1.
//
// Solidity: function register(bytes32 userInternalPublicKey_, bytes s_, bytes n_, (uint256[2],uint256[2][2],uint256[2]) zkPoints_, uint256 proofTimestamp_) returns()
func (_Registration *RegistrationTransactor) Register(opts *bind.TransactOpts, userInternalPublicKey_ [32]byte, s_ []byte, n_ []byte, zkPoints_ VerifierHelperProofPoints, proofTimestamp_ *big.Int) (*types.Transaction, error) {
	return _Registration.contract.Transact(opts, "register", userInternalPublicKey_, s_, n_, zkPoints_, proofTimestamp_)
}

// Register is a paid mutator transaction binding the contract method 0xd8d64da1.
//
// Solidity: function register(bytes32 userInternalPublicKey_, bytes s_, bytes n_, (uint256[2],uint256[2][2],uint256[2]) zkPoints_, uint256 proofTimestamp_) returns()
func (_Registration *RegistrationSession) Register(userInternalPublicKey_ [32]byte, s_ []byte, n_ []byte, zkPoints_ VerifierHelperProofPoints, proofTimestamp_ *big.Int) (*types.Transaction, error) {
	return _Registration.Contract.Register(&_Registration.TransactOpts, userInternalPublicKey_, s_, n_, zkPoints_, proofTimestamp_)
}

// Register is a paid mutator transaction binding the contract method 0xd8d64da1.
//
// Solidity: function register(bytes32 userInternalPublicKey_, bytes s_, bytes n_, (uint256[2],uint256[2][2],uint256[2]) zkPoints_, uint256 proofTimestamp_) returns()
func (_Registration *RegistrationTransactorSession) Register(userInternalPublicKey_ [32]byte, s_ []byte, n_ []byte, zkPoints_ VerifierHelperProofPoints, proofTimestamp_ *big.Int) (*types.Transaction, error) {
	return _Registration.Contract.Register(&_Registration.TransactOpts, userInternalPublicKey_, s_, n_, zkPoints_, proofTimestamp_)
}
